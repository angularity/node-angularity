 ...
 * @param hashKeyword A substring in the directory path that will be replaced with the hash
 * @param isVerbose Determines whether versioned paths are logged to the output
 * @returns {*}
 */
