...
Config.prototype.getConsoleWidth = function () {
  return this.resolveConfigValue('consoleWidth');
};

Config.prototype.getServerHttpPort = function () {
  return this.resolveConfigValue('serverHttpPort');
};

Config.prototype.getJavascriptVersion = function () {
  //validate string values case sensitivity etc
  return this.resolveConfigValue('javascriptVersion');
};

Config.prototype.getWebstormExecutablePath = function () {
