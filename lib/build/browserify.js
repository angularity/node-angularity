...
module.exports = function (bannerWidth) {
  ...
  var self       = {
    ...
    compile: function () {
       ...
       */
      function bundle(stream, require, bundlename, isMinify, done) {
        ...
        var isMinify = (isMinify) && ((typeof isMinify !== 'function') || isMinify(bundlename));
        var bundler  = browserify({
          debug: true
        });

        // plugins
        (isMinify) && bundler.plugin('minifyify', {
          map:    mapPath,
          minify: {
            mangle: {
              toplevel: true,
        ...
        // transforms
        transforms
          .concat(transformTools.makeRequireTransform("requireTransform", null, function(args, opts, done) {
      ...
      return {
        ...
        all: function (outPath, isMinify) {
          ...
          return through.obj(function (file, encoding, done) {
            ...
            bundle(this, pending, outPath, isMinify, done);
          });
        }
      }
    }
